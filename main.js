...
(function () {
  ...
  function initTour($, $$) {
    ...
    const steps = [
      ...
      { emoji: "🎯", title: "About Me", text: "Who I am in a nutshell — a Full-Stack & Cross-Platform Developer with a DevOps mindset, and co-builder of Rescuen (live on the Play Store).", target: "#about" },
      { emoji: "🗺️", title: "My Journey", text: "The path so far — B.Tech IT, my web-dev and AIML internships, industry certifications and shipped products. A quick story of the grind. 📈", target: "#journey" },
      { emoji: "💪", title: "Skills & Tech Stack", text: "Everything I build with — grouped the way recruiters read it: Frontend, Backend & Databases, Mobile, DevOps & Cloud and AI/ML. Hover the cards, they glow! ✨", target: "#skills" },
